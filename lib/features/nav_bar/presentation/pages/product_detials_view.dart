                      ...
                      children: [
                        RatingBar.builder(
                            ...
                            onRatingUpdate: (rating) {
                              ...
                              // For example, you can call the addOrUpdateRating method
                              // from the ProductDetialsCubit to add/update the rating
                              // Example:
                              context.read<ProductDetialsCubit>().addOrUpdateRating(
                                product.productId!,
                                Rate(
                                  rate: rating.toInt(),
                                ),
